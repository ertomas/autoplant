...
const int sensorHumedad = A0;   // Pin analógico A0 para el sensor de humedad (se revierte al pin original)
...
const unsigned long TIEMPO_PAUSA_ANTES_AVANZAR = 3000; // 3 segundos
...
const unsigned long intervaloMedicionDistancia = 250; // Medir distancia cada 50 ms
...
enum EstadoRobot {
  ...
  RETROCEDIENDO,
  GIRANDO,
  PAUSANDO // Nuevo estado para la pausa antes de volver a avanzar
};
